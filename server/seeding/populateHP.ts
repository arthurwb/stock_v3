        ...
        data.forEach(async hp => {
            await prisma.tHistoricalPrices.create({ 
                data: {
                    ...
                    historicalPriceStamp: hp.historicalPriceStamp
                }
            }) 
        });
    }
    ...
    const usersData: HistoricalPrice[] = [
        {
            ...
            historicalPriceStamp: new Date('2024-09-18 08:00:00.000')
        },
        {
            optionId: options.google.id,
            historicalPrice: 496.00 as unknown as Decimal,
            historicalPriceStamp: new Date('2024-09-18 08:05:00.000')
        },
        {
            optionId: options.google.id,
            historicalPrice: 497.00 as unknown as Decimal,
            historicalPriceStamp: new Date('2024-09-18 08:10:00.000')
        },
        {
            optionId: options.google.id,
            historicalPrice: 498.00 as unknown as Decimal,
            historicalPriceStamp: new Date('2024-09-18 08:15:00.000')
        },
        {
            optionId: options.google.id,
            historicalPrice: 499.00 as unknown as Decimal,
            historicalPriceStamp: new Date('2024-09-18 08:20:00.000')
        },
        {
